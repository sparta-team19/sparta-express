    ...
    void testFindShipmentInterhubRoutes() {
        ...
        List<InterhubRoute> interhubRoutes = List.of(
                ...
                InterhubRoute.builder()
                        ...
                        .originHubId(daejon.getId())
                        .destinationHubId(seoul.getId())
                        .distanceKm(300)
                        .estimatedMinutes(180)
                        .build(),
                InterhubRoute.builder()
                        .status(InterhubRouteStatus.ACTIVE)
                        .originHubId(seoul.getId())
                        .destinationHubId(daejon.getId())
                        .distanceKm(300)
                        .estimatedMinutes(180)
                        .build(),
                // 부산 - 대전
                InterhubRoute.builder()
                        .status(InterhubRouteStatus.ACTIVE)
                        .originHubId(daejon.getId())
                        .destinationHubId(busan.getId())
                        .distanceKm(400)
                        .estimatedMinutes(240)
                        .build(),
                InterhubRoute.builder()
                        .status(InterhubRouteStatus.ACTIVE)
                        .originHubId(busan.getId())
                        .destinationHubId(daejon.getId())
                        .distanceKm(400)
                        .estimatedMinutes(240)
                        .build(),
                ...
                InterhubRoute.builder()
                        .status(InterhubRouteStatus.ACTIVE)
                        .originHubId(seoul.getId())
                        .destinationHubId(sejong.getId())
                        .distanceKm(200)
                        .estimatedMinutes(120)
                        .build(),
                InterhubRoute.builder()
                        .status(InterhubRouteStatus.ACTIVE)
                        .originHubId(sejong.getId())
                        .destinationHubId(seoul.getId())
                        .distanceKm(200)
                        .estimatedMinutes(120)
                        .build(),
                ...
                InterhubRoute.builder()
                        .status(InterhubRouteStatus.ACTIVE)
                        .originHubId(seoul.getId())
                        .destinationHubId(gyeongi.getId())
                        .distanceKm(200)
                        .estimatedMinutes(120)
                        .build()
        );
